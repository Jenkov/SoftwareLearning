	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				location = "/ecoobookshop/CartItemServlet?method=batchDelete&cartItemIds=" + id;
			}
		} else {
...
function sendUpdateQuantity(id, quantity) {
	$.ajax({
		async:false,
		cache:false,
		url:"/ecoobookshop/CartItemServlet",
...
function batchDelete() {
	...
	location = "/ecoobookshop/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
}
