$(function() {
	...
	$("#submitBtn").hover(
		function() {
			$("#submitBtn").attr("src", "/ecoobookshop/images/regist2.jpg");
		},
		function() {
			$("#submitBtn").attr("src", "/ecoobookshop/images/regist1.jpg");
		}
	);
...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url:"/ecoobookshop/UserServlet",//要请求的servlet
...
function _hyz() {
	 ...
	 * 3. 使用毫秒来添加参数
	 */
	$("#imgVerifyCode").attr("src", "/ecoobookshop/VerifyCodeServlet?a=" + new Date().getTime());
}
